...
Line(4) = {4, 5};
//+
Point(7) = {x1,   Lcyl, 0, c0};
Point(8) = {x2,   Lcyl, 0, c1};
Point(9) = {x3,   Lcyl, 0, c1};
...
Line(9) = {5, 10};
//+
Point(11) = {x1-R2, Lcyl, 0, c0};
Point(12) = {x2-R2, Lcyl, 0, c1};
Point(13) = {x3-R2, Lcyl, 0, c1};
Point(14) = {x4-R2, Lcyl, 0, c2};
Point(15) = {x1-R2*(1-Cos(b)), Lcyl+R2*Sin(b), 0, c0};
Point(16) = {x2-R2*(1-Cos(b)), Lcyl+R2*Sin(b), 0, c1};
Point(17) = {x3-R2*(1-Cos(b)), Lcyl+R2*Sin(b), 0, c1};
...
Point(22) = {x8, Lc, 0, c2};
//+
Point(23) = {x5+R1, Lc, 0, c0};
Point(24) = {x6+R1, Lc, 0, c1};
Point(25) = {x7+R1, Lc, 0, c1};
Point(26) = {x8+R1, Lc, 0, c2};
Point(27) = {x5+R1*(1-Cos(b)), Lc-R1*Sin(b), 0, c0};
Point(28) = {x6+R1*(1-Cos(b)), Lc-R1*Sin(b), 0, c1};
Point(29) = {x7+R1*(1-Cos(b)), Lc-R1*Sin(b), 0, c1};
...
Line(27) = {18, 30};
//+
Point(31) = {x5+Rn, Lc, 0, c0};
Point(32) = {x6+Rn, Lc, 0, c1};
Point(33) = {x7+Rn, Lc, 0, c1};
Point(34) = {x8+Rn, Lc, 0, c2};
Point(35) = {x5+Rn*(1-Cos(Te)), Lc+Rn*Sin(Te), 0, c0};
Point(36) = {x6+Rn*(1-Cos(Te)), Lc+Rn*Sin(Te), 0, c1};
Point(37) = {x7+Rn*(1-Cos(Te)), Lc+Rn*Sin(Te), 0, c1};
...
x12 = Re+iwt+ct;
x13 = Re+iwt+ct+owt;
Point(40) = {x10, Lc+Le, 0, c0};
Point(41) = {x11, Lc+Le, 0, c1};
Point(42) = {x12, Lc+Le, 0, c1};
...
Extrude {{0, 1, 0}, {0, 0, 0}, 2*Pi/33/8} { Surface{2}; }
Extrude {{0, 1, 0}, {0, 0, 0}, 2*Pi/33/8*6} { Surface{254}; }
Extrude {{0, 1, 0}, {0, 0, 0}, 2*Pi/33/8} { Surface{326}; }
//+
...
//+
Physical Surface("Cyl", 410) = {93};
Physical Surface("Conv", 411) = {97, 101};
Physical Surface("Throat", 412) = {105, 109};
Physical Surface("Nozzle", 413) = {57};
...
//+
Physical Surface("Symmetry1", 408) = {3, 2, 1};
Physical Surface("Symmetry2", 409) = {182, 398, 110};
//+
